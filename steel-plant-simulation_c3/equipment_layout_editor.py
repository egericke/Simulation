...
class EquipmentLayoutEditor(QDialog):
    ...
    def create_ui(self):
        ...
        toolbar.setStyleSheet("QToolBar { spacing: 8px; } QToolButton { font-size: 12px; min-width: 120px; padding: 4px; }")
        toolbar.setIconSize(QSize(32, 32))  # Increase icon size for visibility
        ...
        save_action.setStatusTip("Save the current layout")
        ...
        load_action.setStatusTip("Load a layout from file")
        ...
        grid_action.setStatusTip("Show or hide grid lines")
        ...
        fit_action.setStatusTip("Fit all items in view")
        ...
        self.route_action.setStatusTip("Create routes between equipment")
        ...
        self.bay_action.setStatusTip("Create a new bay area")
        toolbar.addAction(self.bay_action)
        
        toolbar.addSeparator()
        
        delete_action = QAction(QIcon.fromTheme("edit-delete", QIcon("icons/delete.png")), "Delete", self)
        delete_action.triggered.connect(self.delete_selected)
        delete_action.setStatusTip("Delete selected items")
        toolbar.addAction(delete_action)
        
        # Add Route Point Action
        add_point_action = QAction(QIcon.fromTheme("list-add", QIcon("icons/add_point.png")), "Add Point", self)
        add_point_action.triggered.connect(self.add_route_point)
        add_point_action.setStatusTip("Add a new route connection point")
